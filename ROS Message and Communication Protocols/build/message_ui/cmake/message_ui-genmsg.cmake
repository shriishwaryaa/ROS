...
set(MSG_I_FLAGS "-Imessage_ui:/home/shri/ros_hw/src/message_ui/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/shri/ros_hw/src/message_ui/msg/sent_msg.msg" NAME_WE)
add_custom_target(_message_ui_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "message_ui" "/home/shri/ros_hw/src/message_ui/msg/sent_msg.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(message_ui
  "/home/shri/ros_hw/src/message_ui/msg/sent_msg.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/message_ui)
  ...
  string(REGEX REPLACE "([][+.*()^])" "\\\\\\1" ESCAPED_PATH "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/message_ui")
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/message_ui
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
